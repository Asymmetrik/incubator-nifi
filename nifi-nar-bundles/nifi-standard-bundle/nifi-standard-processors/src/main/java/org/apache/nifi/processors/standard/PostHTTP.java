...
@DynamicProperty(name = "Header Name", value = "Header Value", description = "This allows custom headers to be passed with the request. If batching is on and sending as a flowfile, expression language substituions will assume the first value encountered.")
